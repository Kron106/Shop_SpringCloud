...
import com.xjo.product.utils.ResultVOUtil;
import com.xjo.product.vo.ProductInfoVO;
import com.xjo.product.vo.ProductVO;
...
public class ProductController {
    ...
    public ResultVO<ProductVO> list() {
        ...
        List<Integer> categoryTypeList = productInfoList.stream()
                .map(ProductInfo::getCategoryType) //lambda表达式
